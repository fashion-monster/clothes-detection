...
def draw_bounding_box_on_image_array(image,
  ...
  """
    image_pil = Image.fromarray(np.uint8(image)).convert('RGB')
    return draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
...
def draw_bounding_box_on_image(image,
  ...
  """
    ...
    return [left, right, top, bottom, display_str_list]
...
def draw_bounding_boxes_on_image_array(image,
  ...
  """
    ...
    return draw_bounding_boxes_on_image(image_pil, boxes, color, thickness,
                                        display_str_list_list)
...
def visualize_boxes_and_labels_on_image_array(image,
  ...
  """
    ...
    for box, color in box_to_color_map.items():
        ...
        return draw_bounding_box_on_image_array(
            image,
            ymin,
            xmin,
            ymax,
